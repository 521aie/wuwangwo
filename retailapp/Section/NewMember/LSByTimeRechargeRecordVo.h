...
typedef NS_ENUM(NSInteger ,LSByTimeRechargeRecordOperType) {
    LSByTimeRechargeRecordOperType_Recharge = 1, // 充值
    LSByTimeRechargeRecordOperType_Pay,          // 支付
...
@property (nonatomic, strong) NSNumber *action;/**<操作类型：1，充值 2，支付 其他：退款>*/
@property (nonatomic, strong) NSNumber *startDate;/**<有效期：开始时间>*/
@property (nonatomic, strong) NSNumber *endDate;/**<有效期：终止时间>*/
@property (nonatomic, strong) NSNumber *consumeDate;/**<充值时间>*/
...
@property (nonatomic, strong) NSString *opUserNo;/**<操作人NO.>*/
