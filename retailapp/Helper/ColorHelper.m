...
// cc0000
+ (UIColor *)getWhiteColor1 {
    
    return [UIColor colorWithRed:192/255.0 green:0.0 blue:0.0 alpha:1];
}
#pragma 橙色.
+ (UIColor *)getOrangeColor {
    return [UIColor colorWithRed:255/255.0 green:136/255.0 blue:0/255.0 alpha:1];
}

+ (UIColor *)getBackgroundColorf2 {
