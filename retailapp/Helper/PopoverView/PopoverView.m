...
static float const kPopoverViewCellHeight = 30.f; ///< cell指定高度
static float const kPopoverViewArrowHeight = 7.f; ///< 箭头高度
static float const kPopoverTableViewYSpace = 13.0f; // tableview 上下边距离父view间距
...
- (void)layoutSubviews {
    ...
    CGFloat tableViewTopY = kPopoverTableViewYSpace;
    CGFloat tableViewHeight = _isUpward ? kPopoverViewArrowHeight + tableViewTopY : tableViewTopY;
    _tableView.frame = CGRectMake(0, tableViewHeight, CGRectGetWidth(self.bounds), CGRectGetHeight(self.bounds) - kPopoverViewArrowHeight - tableViewTopY*2);
}
...
//    _tableView.scrollEnabled = NO;
    _tableView.estimatedRowHeight = kPopoverViewCellHeight;
...
- (void)showToPoint:(CGPoint)toPoint {
    ...
    CGFloat currentH = _tableView.contentSize.height + kPopoverViewArrowHeight + 2*kPopoverTableViewYSpace;
...
//    }
    ...
    currentX = (_windowWidth - currentW)/2;
