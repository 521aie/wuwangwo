...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor colorWithRed:(170/255.0) green:(170/255.0) blue:(170/255.0) alpha:1.0];
    ...
    if (iOS7Later) {
        self.navigationBar.barTintColor = [ColorHelper getRedColor];//[UIColor colorWithRed:(34/255.0) green:(34/255.0)  blue:(34/255.0) alpha:1.0];
...
- (instancetype)initWithMaxImagesCount:(NSInteger)maxImagesCount delegate:(id<TZImagePickerControllerDelegate>)delegate {
    ...
    if (self) {
        self.maxImagesCount = maxImagesCount >= 0 ? maxImagesCount : 5; // Default is 9 / 默认最大可选9张图片
