...
+ (instancetype)editItemList {
    EditItemList *editItemList = [[EditItemList alloc] initWithFrame:CGRectMake(0, 0, SCREEN_W, 48)];
    return editItemList;
}
...
- (void)initPlaceholder:(NSString *)placeholder {
    ...
    self.lblVal.attributedPlaceholder = [[NSAttributedString alloc] initWithString:placeholder attributes:@{NSForegroundColorAttributeName: color}];
}
