...
- (void)setGoodsInfo:(InstanceVo *)goodsInfo {
    ...
    if ([[Platform Instance] getkey:SHOP_MODE].integerValue == 101 && [NSString isNotBlank:goodsInfo.innerCode]) {
        //服鞋显示  商品名称\n店内码\n颜色尺码
    ...
    } else if ([[Platform Instance] getkey:SHOP_MODE].integerValue == 102 && [NSString isNotBlank:goodsInfo.barCode]){
        //商超显示  商品名称\n商品条码
        //商超没有显示颜色尺码
        //条形码
        [attr appendAttributedString:[[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"\n%@", goodsInfo.barCode]]];
