...
@interface AddStyleByConditionView : BaseViewController<IEditItemListEvent,OptionPickerClient, SymbolNumberInputClient, OptionPickerClient, INavigateEvent>
