...
+ (ItemTitle *)itemTitle:(NSString *)text {
    ...
    ItemTitle *title = [[ItemTitle alloc] initWithFrame:
                        CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 48)];
    title.view.ls_width = CGRectGetWidth([UIScreen mainScreen].bounds);
