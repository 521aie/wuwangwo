...
+ (instancetype)selectImgItem {
    SelectImgItem *view = [[[NSBundle mainBundle] loadNibNamed:@"SelectImgItem" owner:self options:nil] lastObject];
    view.ls_width =  [UIScreen mainScreen].bounds.size.width - 20;
    return view;
}
- (int)getHeight
{
