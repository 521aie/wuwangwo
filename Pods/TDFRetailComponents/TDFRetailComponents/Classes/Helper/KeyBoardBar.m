...
- (id)initWithFrame:(CGRect)frame client:(id<KeyBoardBarClient>)client {
    ...
    if (self) {
        ...
        UIButton *hideBtn = [[UIButton alloc] initWithFrame:CGRectMake(CGRectGetWidth([UIScreen mainScreen].bounds) - HIDE_BTN_HEIGHT, 0, HIDE_BTN_HEIGHT, HIDE_BTN_HEIGHT)];
        [hideBtn setImage:[UIImage imageNamed:@"ico_kb"] forState:UIControlStateNormal];
